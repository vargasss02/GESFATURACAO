  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.block}>
        ...
        <Text style={s.line}>
          Condições de Pagamento: <Text style={s.val}>{data.paymentTerms}</Text>
        </Text>
        <Text style={s.line}>
        ...
        {!!data.observations && (
          <Text style={s.line}>
            Observações: <Text style={s.val}>{data.observations}</Text>
          </Text>
        )}
      </View>
      ...
      <View style={s.block}>
        ...
        <View style={s.totals}>
          ...
          <Text style={s.totalLine}>
            Retenção: <Text style={s.val}>{fmtMoney(data.subtotals.withholding)}</Text>
          </Text>
